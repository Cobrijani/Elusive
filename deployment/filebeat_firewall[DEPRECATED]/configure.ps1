...
$wlb_dir = "C:\Program Files\Filebeat"
...
function LoadTemplate{
    ...
    Invoke-WebRequest -Method Put -InFile "C:\\Program Files\Filebeat\filebeat.template.json" -Uri  http://localhost:9200/_template/filebeat?pretty -ContentType application/json
}
