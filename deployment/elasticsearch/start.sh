...
curl -k \
   ...
   -d "{ \"cluster\": [\"manage_index_templates\", \"monitor\"], \"indices\": [{ \"names\": [\"logstash-*\", \"linuxbeat-*\", \"firebeat-*\", \"appbeat-*\", \"apachebeat-*\",\"winlogbeat-*\", \"atmbeat-*\", \"apachemainbeat-*\", \"packetbeat-*\"], \"privileges\": [\"write\", \"delete\", \"create_index\"]}]}" \
